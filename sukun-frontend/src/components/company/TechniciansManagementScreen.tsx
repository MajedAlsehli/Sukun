        ...
        {screen === "list" && (
          <div>
            ...
            <div style={{ position: "relative", marginBottom: "13px" }}>
              ...
              <input style={searchStyle} value={query} onChange={(e) => setQuery(e.target.value)} placeholder="ابحث بالاسم أو الجوال أو البريد أو التخصص أو المشروع" autoComplete="off" />
            </div>
